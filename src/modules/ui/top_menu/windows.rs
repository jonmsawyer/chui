...
pub fn windows(ui: &mut Ui) -> InnerResponse<Option<()>> {
    egui::menu::menu_button(ui, layout_jobs::top_menu_windows(), |ui| {
        // Windows > Board
        if ui.button(layout_jobs::top_menu_board())
            .clicked()
        {
        ...
        // Windows > Clock
        if ui.button(layout_jobs::top_menu_clock())
            .clicked()
        {
        ...
        // Windows > Notation
        if ui.button(layout_jobs::top_menu_notation())
            .clicked()
        {
        ...
        // Windows > Engine
        if ui.button(layout_jobs::top_menu_engine())
            .clicked()
        {
        ...
        // Windows > Moves
        if ui.button(layout_jobs::top_menu_moves())
            .clicked()
        {
        ...
        // Windows > Histogram
        if ui.button(layout_jobs::top_menu_histogram())
            .clicked()
        {
