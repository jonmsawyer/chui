...
pub fn engines(ui: &mut Ui) -> InnerResponse<Option<()>> {
    ...
    egui::menu::menu_button(ui, layout_jobs::top_menu_engines(), |ui| {
        ...
        if ui.button(layout_jobs::top_menu_engine_options())
            .clicked()
        {
        ...
        // Engines > Hash Tables...
        if ui.button(layout_jobs::top_menu_hash_tables())
            .clicked()
        {
            println!("Hash Tables was clicked");
        }
        // Engines > Permanent Brain
        if ui.button(layout_jobs::top_menu_permanent_brain())
            .clicked()
        {
        ...
        if ui.button(layout_jobs::top_menu_install_engine())
            .clicked()
        {
        ...
        if ui.button(layout_jobs::top_menu_uninstall_engine())
            .clicked()
        {
        ...
        if ui.button(layout_jobs::top_menu_edit_engine_file())
            .clicked()
        {
        ...
        if ui.button(layout_jobs::top_menu_endgame_databases())
            .clicked()
        {
