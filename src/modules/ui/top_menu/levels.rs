...
pub fn levels(ui: &mut Ui) -> InnerResponse<Option<()>> {
    egui::menu::menu_button(ui, layout_jobs::top_menu_levels(), |ui| {
        ...
        if ui.button(layout_jobs::top_menu_playing_strength())
            .clicked()
        {
        ...
        // Levels > Blitz...
        if ui.button(layout_jobs::top_menu_blitz())
            .clicked()
        {
        ...
        if ui.button(layout_jobs::top_menu_time_per_move())
            .clicked()
        {
        ...
        if ui.button(layout_jobs::top_menu_time_controls())
            .clicked()
        {
        ...
        if ui.button(layout_jobs::top_menu_fixed_search_depth())
            .clicked()
        {
