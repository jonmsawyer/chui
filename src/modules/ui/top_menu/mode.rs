...
pub fn mode(ui: &mut Ui) -> InnerResponse<Option<()>> {
    egui::menu::menu_button(ui, layout_jobs::top_menu_mode(), |ui| {
        // Mode > Analysis
        if ui.button(layout_jobs::top_menu_analysis())
            .clicked()
        {
        ...
        if ui.button(layout_jobs::top_menu_play_against_computer())
            .clicked()
        {
        ...
        // Mode > Enter Moves
        if ui.button(layout_jobs::top_menu_enter_moves())
            .clicked()
        {
        ...
        // Mode > Triple Brain...
        if ui.button(layout_jobs::top_menu_triple_brain())
            .clicked()
        {
        ...
        // Mode > Ananlyse Game...
        if ui.button(layout_jobs::top_menu_analyse_game())
            .clicked()
        {
        ...
        if ui.button(layout_jobs::top_menu_analyse_positions())
            .clicked()
        {
        ...
        // Mode > DGT Board
        if ui.button(layout_jobs::top_menu_dgt_board())
            .clicked()
        {
