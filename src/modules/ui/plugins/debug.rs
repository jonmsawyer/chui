...
use super::super::utils::{compute_board_coords, get_mouse_coords, get_world_coords};
...
pub fn debug_panel(
    ...
    if ui_state.debug_window {
        ...
        if fps.average > f32::EPSILON {
            ...
            ui.label(format!(
                "Mouse Screen Coords: {}, {}",
                cursor[0] as i32, cursor[1] as i32
            ));
            ui.label(format!(
                "Mouse World Coords: {}, {}",
                coords[0] as i32, coords[1] as i32
            ));
            ui.label(format!(
                "Mouse Click Coords: {}, {}",
                ui_state.mouse_click_coords[0] as i32, ui_state.mouse_click_coords[1] as i32
            ));
            ui.label(format!(
                "Mouse Click Board Coords: {}{}",
                ui_state.mouse_click_board_coords.0, ui_state.mouse_click_board_coords.1
            ));
