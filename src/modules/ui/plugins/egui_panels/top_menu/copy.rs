...
pub fn copy(ui: &mut Ui) -> InnerResponse<Option<()>> {
    ...
    egui::menu::menu_button(ui, layout_jobs::top_menu_copy(), |ui| {
        ...
        if ui.button(layout_jobs::top_menu_copy_pgn())
            .clicked()
        {
        ...
        if ui.button(layout_jobs::top_menu_copy_epd())
            .clicked()
        {
        ...
        if ui.button(layout_jobs::top_menu_copy_analysis_window())
            .clicked()
        {
        ...
        if ui.button(layout_jobs::top_menu_copy_last_analysis())
            .clicked()
        {
        ...
        if ui.button(layout_jobs::top_menu_copy_notation())
            .clicked()
        {
